            ...
            <div className="flex-1 space-y-8">
              ...
              <div className="space-y-6">
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">
                  Recognized by{' '}
                  <span className="text-[#32addb] dark:text-[#32addb]">Startup India</span>{' '}
                  Initiative
                </h2>
                <p className="text-lg text-[#125872] dark:text-[#32addb]/90">
                  We're proud to be officially recognized under the Startup India initiative 
                  by the Government of India, validating our commitment to revolutionizing 
                  healthcare accessibility across the nation.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white dark:bg-[#125872]/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow backdrop-blur-sm border border-[#32addb]/20 dark:border-[#32addb]/10 group">
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-[#32addb]/10 dark:bg-[#32addb]/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                      <svg className="w-6 h-6 text-[#125872] dark:text-[#32addb]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-[#125872] dark:text-white">Government Certified</h3>
                      <p className="text-sm text-[#125872]/70 dark:text-[#32addb]/80 mt-1">DPIIT Recognized Healthcare Startup</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-[#125872]/30 rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow backdrop-blur-sm border border-[#32addb]/20 dark:border-[#32addb]/10 group">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#125872] dark:text-white">Innovation Leader</h3>
                      <p className="text-sm text-[#125872]/70 dark:text-[#32addb]/80 mt-1">Digital Healthcare Pioneer</p>
                    </div>
                  </div>
                </div>
              </div>
